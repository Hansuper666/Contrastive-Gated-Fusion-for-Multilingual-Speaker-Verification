...
# Train on English, Test on English and German
...
# Data files
TRAIN_FILE="${DATA_ROOT}/v3/English_train.txt"
...
echo "  ${OUTPUT_DIR}/sub_score_English_heard.txt"
echo "  ${OUTPUT_DIR}/sub_score_German_unheard.txt"
echo ""
